<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EmployeesRoleUsrCtrl.ascx.cs" Inherits="AspDotNetProject_Final_Elias.UserControls.EmployeesRoleUsrCtrl" %>
<br /> <br />
    ...
    <div class="row">
        <div class="col-sm-12 table-responsive">
            ...
            <asp:GridView ID="grdUsers" runat="server" DataKeyNames="Id"
               ...
               ItemType="AspDotNetProject_Final_Elias.Models.ApplicationUser" 
